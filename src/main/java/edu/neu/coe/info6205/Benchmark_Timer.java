...
import edu.neu.coe.info6205.LazyLogger;

import static edu.neu.coe.info6205.Utilities.formatWhole;
...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    public double runFromSupplier(Supplier<T> supplier, int m) {
        ...
        new edu.neu.coe.info6205.Timer().repeat(getWarmupRuns(m), supplier, function, fPre, null);

        // Timed phase
        return new edu.neu.coe.info6205.Timer().repeat(m, supplier, function, fPre, fPost);
    }
